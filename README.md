...
The goal of regexcite.show is to make regular expressions more exciting!
It provides convenience functions to make some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the development version of regexcite.show from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("showcy/regexcite.show")
```
...
That’s exactly what `regexcite.show::str_split_one()` does.

``` r
library(regexcite.show)
